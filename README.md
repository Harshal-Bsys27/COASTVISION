...
### Gallery (repo-hosted screenshots)

Below are repository-hosted screenshots (replace or add more images in `docs/screenshots/`):

- Dashboard overview

  ![Dashboard overview](docs/screenshots/DASHBOARD.png)

- Analytics dashboard (person count & charts)

  ![Analytics dashboard](docs/screenshots/ANALYTICSDASHBOARD.png)

- Analytics detail (timeline)

  ![Analytics timeline](docs/screenshots/ANALYTICS.png)

- Event logs (timeline of detections)

  ![Event logs](docs/screenshots/Eventlog.png)

- Lifeguards tab (Telegram registration, Stop/Resume)

  ![Lifeguards tab](docs/screenshots/LIFEGUARDS.png)

If any image is missing here, add the image file to `docs/screenshots/` (see [docs/screenshots/README.md](docs/screenshots/README.md) for naming and caption guidance) and the gallery will display it automatically on GitHub.
