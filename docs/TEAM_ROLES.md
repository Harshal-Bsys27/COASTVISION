...
1. **Harshal** (Team Lead & Core Architect) - 
2. **Hardik** (Lead Frontend Engineer) - 
3. **Sara** (Research, Analytics & Deployment) - 
4. **Komal** (Data Curation & API Integration) - 

## Detailed Technical Contributions

### 1. Harshal - Team Lead & Core AI/Backend Architect 
...
### 3. Sara - Research, Analytics & Deployment Specialist 
...
### 4. Komal - Data Curation & Alert Integration 
